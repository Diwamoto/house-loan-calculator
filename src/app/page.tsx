...
import { calculateLoan, LoanParameters, LoanResult } from '../utils/loanCalculator';

export default function Home() {
  const [params, setParams] = useState<LoanParameters>({
    amount: 30000000, // デフォルト値：3000万円
    years: 35,
    interestRate: 0.425, // 2024年3月時点の主要銀行の金利
  });
                ...
                <div className="aws-card bg-white p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-3">
                      <div className="aws-card p-4 bg-gray-50">
                        ...
                        <div className="space-y-2">
                          ...
                          {result.investmentResult === -1 ? (
                            ...
                            <>
                              ...
                              <p className="text-sm text-gray-900"><span className="font-medium">税制考慮後の投資結果：</span>{formatCurrency(result.investmentWithTax)}</p>
              ...
              <div className="aws-card p-6 bg-white border-2 border-blue-200 shadow-lg rounded-lg">
                ...
                <div className="grid grid-cols-3 gap-8">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <p className="text-sm text-gray-900"><span className="font-medium">売却時点での投資収益（税引後）：</span>{formatCurrency(result.landSale.investmentAtSale)}</p>
